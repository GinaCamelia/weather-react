    ...
    return (
      <div className="Footer">
        <div className="link-github">
              ...
              className="link"
              target="_blank"
              rel="noreferrer">Gina-Camelia Hodorogea </a> and hosted on <a href="https://euphonious-gnome-570ef0.netlify.app" target="_blank" rel="no referrer" className="link">Netlify</a>
            </div>
